class EmploymentsController < ApplicationController
  ...
  private
    ...
    def employment_params
      params.require(:employment).permit(:work_site_name, :point_of_contact,:occupation,:position_type, :salary_per_hour, :start_date, :end_date, :working_hours_per_week,:completed,:outcome)
    end
end
